...
MidiAssignment {
	...
	Repeater {
		...
		Item {
			...
			AutoLoop {
				...
				shiftPushAction: Action.IncreaseBeatJumpSize
				ledType: LedType.Simple
			}
	...
	Repeater {
		...
		Item {
			...
			VUMeter {
				dBThresholds: [-36.71, -24.37, -19.85, -13.49, -1.0, 30.0]
				ledCCValues: [0, 25, 50, 75, 100, 127]
				vuMeterType: VUMeterType.Channel
				vuLedCCIndexing: VULedCCIndexing.Incremental
				hardwareMasterMeter: true
