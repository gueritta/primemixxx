...
PrimeGo.init = function(_id, _debug) {
    ...
    const decks = [
        new PrimeGo.Deck(1, 4),
        new PrimeGo.Deck(2, 5),
    ];
...
PrimeGo.Deck = function(deckNumbers, midiChannel) {
    ...
    // Performance Pads
    this.padGrid = new PrimeGo.PadSection(this, midiChannel - 4);
    ...
    this.deckLoad = new components.Button({
        ...
        shift: function() {
            this.inKey = "eject";
            this.outKey = this.inKey;
            this.off = PrimeGo.rgbCodeSysex.whiteDark;
            this.on = PrimeGo.rgbCodeSysex.white;
        },
        unshift: function() {
